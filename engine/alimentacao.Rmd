...
sub <- which(dadosFil$ano==2015 & dadosFil$mes %in% c("Jul") & 
                     dadosFil$tipo=="alimentação" & dadosFil$valor > 50) 

dados.sel <- dadosFil[sub,]
rank <- order(dados.sel$valor, decreasing = TRUE)

kable(dados.sel[rank,c(1,6,7)], caption = "Gastos em julho de 2015")
...
kable(dados.sel[rank,c(1,6,7)], caption = "Gastos em julho de 2016")
...
kable(dados.sel[rank,c(1,6,7)], caption = "Gastos em junho de 2017")
```
